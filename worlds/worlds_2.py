...
def do_global_perturbation(solutions):
  perturbator_vector = cauchy.rvs(loc = 0, scale=1, size=(SOLUTIONS_SIZE,VECTOR_SIZE))
  new_vector =  perturbator_vector + solutions
  new_vector = np.clip(new_vector,-499.0 , 499.0)
  return new_vector

def do_local_perturbation(solutions):
  perturbator_vector = np.random.normal(loc = 0, scale=0.2, size=(SOLUTIONS_SIZE,VECTOR_SIZE))
  new_vector =  perturbator_vector + solutions
  new_vector = np.clip(new_vector,-499.0 , 499.0)
  return new_vector
